...
\input{sections/2_explorative_analysis}
\input{sections/3_base_model}
\input{sections/4_data_augmentation}
\input{sections/5_regularization}
\input{sections/6_pretrained_model}
